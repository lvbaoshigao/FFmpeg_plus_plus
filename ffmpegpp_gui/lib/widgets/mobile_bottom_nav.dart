  ...
  Widget build(BuildContext context) {
    ...
    return GlassPillNavBar(
      ...
      style: GlassPillNavBarStyle(
        ...
        bottomPadding: 10,
        blurSigma: 20,
        backgroundColor: scheme.surface.withValues(alpha: isDark ? 0.30 : 0.22),
        // 顶部高光描边（液态玻璃标志性特征）
        borderColor: Colors.white.withValues(alpha: isDark ? 0.14 : 0.30),
        borderWidth: 0.8,
        pillColors: [
          Colors.white.withValues(alpha: isDark ? 0.78 : 0.95),
          Colors.white.withValues(alpha: isDark ? 0.58 : 0.78),
